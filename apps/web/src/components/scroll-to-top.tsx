...
export function ScrollToTop() {
  ...
  return (
    <button
      ...
      className={`group fixed bottom-6 right-6 z-[90] flex h-10 w-10 items-center justify-center border border-border bg-background/80 text-foreground/70 backdrop-blur-md transition-all duration-300 hover:border-primary hover:text-primary md:bottom-8 md:right-8 ${
        isVisible
